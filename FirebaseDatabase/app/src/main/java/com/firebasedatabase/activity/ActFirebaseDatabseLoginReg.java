...
public class ActFirebaseDatabseLoginReg extends BaseActivity{
    ...
    private void setupViewPager() {
        ...
        adapter.addFragment(new FragFirebaseDBLogin(), "Login");
        adapter.addFragment(new FragFirebaseDBSignUp(), "Register");
